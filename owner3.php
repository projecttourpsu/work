...
<head>
  <title> สถานะการจอง (ผู้ประกอบการ) </title>
  <meta charset="utf-8">
...
<body id="top">
      ...
      <div class="fl_right"><br>
        <ul>
          ...
          <button type="button" class="btn btn-warning"  data-toggle="modal"
            data-target="#myModaluser">ออกจากระบบ</button>
            ...
            <div class="modal-dialog" role="document">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <form method="post" action="login_process.php" name="login_form">
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal">&times;</button>
                      <center>
                        <h2 class="modal-title">
                          <FONT COLOR=#000000>ออกจากระบบ</FONT>
                        </h2>
                      </center>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="username" class="form-control" id="username" placeholder="กรุณากรอกชื่อผู้ใช้งาน"
                        name="username">
                    </div>
                    <div class="form-group">
                      <label for="pwd">รหัสผู้ใช้งาน:</label>
  ...
  <div class="wrapper row2">
    <main class="hoc container clear">
      ...
      <div class="sectiontitle">
        <h6 class="heading submenu1">สถานะการจอง</h6>
        <p></p>
      </div>
      <div class="group">
  ...
  <div class="wrapper row4 overlay" style="background-image:url('images/demo/backgrounds/22.jpg');">
    <footer id="footer" class="hoc clear">
      ...
      <div class="one_third">
        ...
        <figure><a href="#"><img class="borderedbox inspace-10 btmspace-15" src="images/demo/backgrounds/23.jpg"
              alt=""></a>
          <figcaption>
  ...
  <div class="wrapper row5">
    <div id="copyright" class="hoc clear">
      ...
      <p class="fl_right"> <a target="_blank" href="http://www.os-templates.com/"
          title="Free Website Templates">มหาวิทยาลัยสงขลานครินทร์ วิทยาเขตตรัง</a></p>
      <!-- ################################################################################################ -->
    </div>
  </div>
