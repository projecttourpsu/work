...
<head>
    <title> แพ็คเกจทัวร์(นักท่องเที่ยว)</title>
    <meta charset="utf-8">
...
<a class="btn btn-danger" href="../index.php" role="button">ออกจากระบบ</a>
    ...
    <div class="wrapper row1">
        ...
        <nav id="mainav" class="hoc clear">
            ...
            <ul class="clear">
                ...
                <li><a class="mainmenu" href="#">แพ็คเกจทัวร์</a></li>
                <li><a class="mainmenu" href="#">ข้อมูลส่วนตัว</a></li>
    ...
    <div class="wrapper  ">
        <main class=" container clear">
            ...
            <div class="sectiontitle">
                ...
                <h6 class="heading submenu1">แพ็คเกจทัวร์</h6>
                <div class="fl_right"><br>
 ...
 //คำสั่งให้เลือกข้อมูลจาก TABLE ชื่อ tbl_member โดยเรียงจาก member_id และให้เรียงลำดับจากมากไปน้อยคือ DESC และ เปิดดู error เวลามีปัญหา
                    $query = "SELECT * FROM package1 ORDER BY pk_id  " or die("Error:" . mysqli_error());
                    //ประกาศตัวแปร sqli
                    ...
                    <tr class="active">
                        ...
                        <td align="center"><a href="#?pk_id=<?php echo $row['pk_id'];?> " title="รายละเอียด"  class="btn btn-warning  fa fa-file-text-o" role="button" ></a>
                            <!--กรณีส่งค่าไปแก้ไข-->

                            <td ><a href="admin_package_del.php?pk_id= <?php echo $row['pk_id']; ?> " onclick="return confirm('ต้องการลบข้อมูลหรือไม่ ? ')" title="ลบข้อมูล"  class="btn btn-danger  fa fa-close" role="button"></a></td>
                        <!--<td align="center"><a href='package_del.php'<?php echo $row['pk_id']; ?>
                         onclick="return confirm('Do you want to delete this record? !!!')">ลบ</a></td> <!-กรณีส่งค่าไปลบ-->
