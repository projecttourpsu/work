...
$sql = "SELECT * from	member  
    ...
    INNER JOIN district ON member.mb_district = district.DISTRICT_ID  where mb_id= '$mb_id'";
    ...
    <div class="wrapper row2">
        <main class="hoc container clear">
            ...
            <?php
                ...
                $query = "SELECT * FROM member where mb_username = '$mb_username'";
                ...
                <div class="clear">
                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="admin_edit_member.php?id=<?php echo $_GET['id'];?>" name="insert_form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5 ">
                                <?php echo "<input type=\"password\"class=\"form-control\" name=\"mb_password\" value = \"$mb_password\"readonly>"; ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5 ">
                                <?php echo "<input type=\"text\"class=\"form-control\" name=\"mb_name\" value = \"$mb_name\"readonly>"; ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5 ">
                                <?php echo "<input type=\"text\"class=\"form-control\" name=\"mb_lname\" value = \"$mb_lname\"readonly>"; ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5 ">
                                <?php echo "<input type=\"text\"class=\"form-control\" name=\"mb_phone\" value = \"$mb_phone\"readonly>"; ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5 ">
                                <?php echo "<input type=\"text\"class=\"form-control\" name=\"mb_email\" value = \"$mb_email\"readonly>"; ?>
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-3">รูปบัตรประชาชน</label>
                            <div class="col-sm-3">
                                <img src="../fileupload/member/<?php echo"$mb_img"; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                ...
                                <?php echo"<select class=\"form-control\" id=\"mb_status\" name=\"mb_status\">
                               <option value=\"\" >$mb_status </option>
